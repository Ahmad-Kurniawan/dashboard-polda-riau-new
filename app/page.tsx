...
import DesaRangking from "@/components/program-satu/DesaRangking";
...
const MapMarkerNew = dynamic(() => import("@/components/program-satu/MapMarkerNew"), {
  ssr: false,
  loading: () => (
    <div className="h-[500px] flex items-center justify-center bg-gray-100">
      <p className="text-black">Loading...</p>
    ...
    <div className="bg-gradient-to-l from-emerald-50 to-emerald-200">
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          {/* Tab Program */}
          <Tabs defaultValue="program-satu" className="w-full">
